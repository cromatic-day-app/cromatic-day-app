    ...
    return (
      <React.Fragment>
        ...
        render() {
                this.fetchUser();
                return ( <
                        React.Fragment > {!this.state.hide ?
                            < MainNav user = { this.state.loggedInUser }
                            qty = { this.state.qty } > < /MainNav> :
                                < div >
                                <
                                div className = 'topHeader' >
                                <
                        ...
                        render = {
                            ...
                            render = {
                                ...
                                render = {
                                    ...
                                    <
                                    Route exact path = '/events/:genre/:artworkId'
                                    render = {
                                        () =>
                                        ...
                                        render = {
                                            () =>
                                            this.state.loggedInUser ? < Profile {...this.state.loggedInUser }
